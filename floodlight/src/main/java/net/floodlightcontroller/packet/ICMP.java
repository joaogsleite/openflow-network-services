...
public class ICMP extends BasePacket {
    ...
    /**
     * @param icmpIdentifier to set
     */
    public ICMP setIcmpIdentifier(int icmpIdentifier) {
    ...
    public byte[] serialize() {
        ...
        bb.putChar((char)this.icmpIdentifier);
    ...
    public IPacket deserialize(byte[] data, int offset, int length)
        ...
        short identifier = bb.getShort();
        this.icmpIdentifier = identifier>=0 ? identifier : 0x10000+identifier;
